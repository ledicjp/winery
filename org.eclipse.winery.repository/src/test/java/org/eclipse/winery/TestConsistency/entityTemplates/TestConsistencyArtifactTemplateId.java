package org.eclipse.winery.TestConsistency.entityTemplates;
 ...
 */
public class TestConsistencyArtifactTemplateId extends AbstractResourceTest {
	...
	public void testConsistency() throws Exception{
		...
		Set<ArtifactTemplateId> list = Repository.INSTANCE.getAllTOSCAComponentIds(ArtifactTemplateId.class);
		// Get All ArtifactTemplateId from Repository 
		for (ArtifactTemplateId id : list) { // Iterate all ArtifactTemplateId
