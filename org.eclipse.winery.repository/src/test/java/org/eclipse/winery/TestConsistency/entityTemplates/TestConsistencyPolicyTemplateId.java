 ...
 */
public class TestConsistencyPolicyTemplateId extends AbstractResourceTest {
	...
	public void testConsistency() throws Exception{
		...
		Set<PolicyTemplateId> list = Repository.INSTANCE.getAllTOSCAComponentIds(PolicyTemplateId.class);
		// Get All PolicyTemplateIds from Repository 
		for (PolicyTemplateId id : list) { // Iterate all PolicyTemplateIds
