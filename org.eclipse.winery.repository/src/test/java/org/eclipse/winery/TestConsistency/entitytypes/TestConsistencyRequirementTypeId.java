 ...
 */
public class TestConsistencyRequirementTypeId extends AbstractResourceTest {
	...
	public void testConsistency() throws Exception{
		...
		Set<RequirementTypeId> list = Repository.INSTANCE.getAllTOSCAComponentIds(RequirementTypeId.class);
		// Get All PolicyTemplateIds from Repository 
		for (RequirementTypeId id : list) { // Iterate all PolicyTemplateIds
