 ...
 */
public class TestConsistencyServiceTemplateId extends AbstractResourceTest {
	...
	public void testConsistency() throws Exception{
		...
		Set<ServiceTemplateId> list = Repository.INSTANCE.getAllTOSCAComponentIds(ServiceTemplateId.class);
		// Get All PolicyTemplateIds from Repository 
		for (ServiceTemplateId id : list) { // Iterate all PolicyTemplateIds
