 ...
 */
public class TestConsistencyPolicyTypeId extends AbstractResourceTest {
	...
	public void testConsistency() throws Exception{
		...
		Set<PolicyTypeId> list = Repository.INSTANCE.getAllTOSCAComponentIds(PolicyTypeId.class);
		// Get All PolicyTemplateIds from Repository 
		for (PolicyTypeId id : list) { // Iterate all PolicyTemplateIds
