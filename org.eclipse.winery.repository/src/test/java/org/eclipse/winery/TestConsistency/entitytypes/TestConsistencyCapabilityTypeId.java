 ...
 */
public class TestConsistencyCapabilityTypeId extends AbstractResourceTest {
	...
	public void testConsistency() throws Exception{
		...
		Set<CapabilityTypeId> list = Repository.INSTANCE.getAllTOSCAComponentIds(CapabilityTypeId.class);
		// Get All PolicyTemplateIds from Repository 
		for (CapabilityTypeId id : list) { // Iterate all PolicyTemplateIds
