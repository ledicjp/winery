 ...
 */
public class TestConsistencyRelationshipTypeImplementationId extends AbstractResourceTest {
	...
	public void testConsistency() throws Exception{
		...
		Set<RelationshipTypeImplementationId> list = Repository.INSTANCE.getAllTOSCAComponentIds(RelationshipTypeImplementationId.class);
		// Get All PolicyTemplateIds from Repository 
		for (RelationshipTypeImplementationId id : list) { // Iterate all PolicyTemplateIds
