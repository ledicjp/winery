 ...
 */
public class TestConsistencyArtifactTypeId extends AbstractResourceTest {
	...
	public void testConsistency() throws Exception{
		...
		Set<ArtifactTypeId> list = Repository.INSTANCE.getAllTOSCAComponentIds(ArtifactTypeId.class);
		// Get All ArtifactTemplateId from Repository 
		for (ArtifactTypeId id : list) { // Iterate all ArtifactTemplateId
