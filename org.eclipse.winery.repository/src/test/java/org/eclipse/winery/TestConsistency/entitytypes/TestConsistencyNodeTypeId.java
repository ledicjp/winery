 ...
 */
public class TestConsistencyNodeTypeId extends AbstractResourceTest {
	...
	public void testConsistency() throws Exception{
		...
		Set<NodeTypeId> list = Repository.INSTANCE.getAllTOSCAComponentIds(NodeTypeId.class);
		// Get All ArtifactTemplateId from Repository 
		for (NodeTypeId id : list) { // Iterate all ArtifactTemplateId
