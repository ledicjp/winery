...
public class DASpecification {
	...
	public static List<TArtifactType> getArtifactTypeHierarchy (TArtifactType artifactType) {
		...
		while (artifactType != null) {
			if (artifactType.getDerivedFrom() != null) {
				QName parentArtifactTypeQName = artifactType.getDerivedFrom().getTypeRef();
				...
				artifactTypeHierarchy.add(basisArtifactType);
				artifactType = basisArtifactType;
			} else {
				artifactType = null;
			}
		}
