...
var implementations_component_1 = require("./implementations.component");
var ImplementationsModule = (function () {
    function ImplementationsModule() {
    }
    return ImplementationsModule;
}());
ImplementationsModule = __decorate([
    core_1.NgModule({
        imports: [
        ...
        exports: [],
        declarations: [
            implementations_component_1.ImplementationsComponent
        ],
        providers: [],
    })
], ImplementationsModule);
exports.ImplementationsModule = ImplementationsModule;
//# sourceMappingURL=implementations.module.js.map