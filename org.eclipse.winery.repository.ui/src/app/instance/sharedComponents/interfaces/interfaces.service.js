...
var InterfacesService = (function () {
    ...
    InterfacesService.prototype.save = function (interfacesData) {
        ...
        return this.http.post(configuration_1.backendBaseURL + this.path + '/', JSON.stringify(interfacesData), options);
    };
    ...
    InterfacesService.prototype.getRelationshipInterfaces = function (url) {
        return rxjs_1.Observable
            .forkJoin(this.get(url + '/targetinterfaces/').map(function (res) { return res.json(); }), this.get(url + '/sourceinterfaces/').map(function (res) { return res.json(); })).map(function (res) {
    ...
    InterfacesService.prototype.get = function (url) {
        ...
        var options = new http_1.RequestOptions({ headers: headers });
        return this.http.get(configuration_1.backendBaseURL + url, options);
    };
