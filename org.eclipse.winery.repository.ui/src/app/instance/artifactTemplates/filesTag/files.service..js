...
var FilesService = (function () {
    function FilesService(http, sharedData) {
        this.http = http;
        this.sharedData = sharedData;
        this.path = configuration_1.backendBaseURL + this.sharedData.path + '/files/';
    }
    ...
    Object.defineProperty(FilesService.prototype, "uploadUrl", {
        get: function () {
            return this.path;
        },
        enumerable: true,
    ...
    FilesService.prototype.delete = function (fileToRemove) {
